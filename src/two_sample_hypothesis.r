...
TwoSampleHypothesisTest <- setRefClass("TwoSampleHypothesisTest",
 ...
 methods=list(
   ...
   find_p_value_greater_than = function() {
     1 - pnorm((sample_one$sample_average - sample_two$sample_average), 0, sqrt((sample_one$standard_deviation^2/sample_one$size + sample_two$standard_deviation^2/sample_one$size)))
   },
